...
| Revision-gap recovery, snapshot/replay selection, client cursor application | [`livehost-recovery.acceptance.mjs`](../../tests/runtime-probes/livehost-recovery.acceptance.mjs), [`livehost-client-recovery.acceptance.mjs`](../../tests/runtime-probes/livehost-client-recovery.acceptance.mjs), [`livehost-bootstrap.acceptance.mts`](../../tests/livehost-bootstrap.acceptance.mts) |
| Persistence ordering and durable failure boundaries | [`livehost-persistence.acceptance.mjs`](../../tests/runtime-probes/livehost-persistence.acceptance.mjs) |
