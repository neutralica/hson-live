...
* <_-obj> tags must contain unique keys/`$_tag` values; duplicate keys are invalid and will throw
...
#### <_-str>
String: Represents a string literal. Only <<_-str>> tags may contain raw string primitives in their `$_content` property.

#### <_-val>
Value: Represents a non-string primitive literal (number, boolean, null). Only <_-val> tags may contain raw non-string data in their `$_content` property
