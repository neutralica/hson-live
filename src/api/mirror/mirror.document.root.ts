...
import {
  ...
  DOCUMENT_MIRROR_ROOT_KIND_MISMATCH_ERROR_CODE,
  DOCUMENT_MIRROR_ROOT_MATERIAL_MISSING_ERROR_CODE,
  DOCUMENT_MIRROR_ROOT_QUID_CONFLICT_ERROR_CODE,
  DOCUMENT_MIRROR_ROOT_VALIDATION_FAILED_ERROR_CODE,
  DocumentMirrorError,
...
/** Require the internal rooted-document carrier used by Mirror. @internal */
