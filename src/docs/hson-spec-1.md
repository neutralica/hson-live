...
# HSON Spec Part 1 
# Syntax, Structure, and Invariants
...
The HsonNode graph is lossless, order-preserving, and round-trip stable.

This section defines the structure, invariants, and semantics of that graph.
...
Especially When derived from native HTML, HsonNode _content may contain a mix of:
	•	HsonNodes
	•	primitive values (typically strings) - these must always be contained within <_str> or <_val> tags, as noted above
Attempting this mixed content within a JSON could lead to creation of an object with a invalid keyless value like an array:
{a: "1", b: "2", "no key", d: "4"  }
