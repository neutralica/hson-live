...
clientMap.lib.add({ preferences: { data: { theme: "dark" } } });
assert.throws(() => clientMap.lib.add({ base: { data: { count: 9 } } }), /duplicat/i);
...
collisionClientMap.lib.add({ shared: { data: { owner: "local" } } });
