...
export const HSON_LIVE_TEST_METADATA = Object.freeze({
  ...
  title: "Hson canonical structural mode",
  category: "Transform",
  runtime: "node",
  tags: Object.freeze(["hson", "parsing", "canonical-graph", "structural-mode"]),
});

const testEvents = create_test_event_emitter("transform.hson-structural-mode");
let checks = 0;
