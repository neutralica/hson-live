...
export const HSON_LIVE_TEST_METADATA = Object.freeze({
  id: "mirror.linked-no-mint-projection",
  title: "Document Mirror linked no-mint projection",
  category: "Mirror",
  runtime: "node-synthetic-dom",
  tags: Object.freeze(["document", "binding", "quid", "runtime", "externally-discoverable"]),
});

const testEvents = create_test_event_emitter("mirror.linked-no-mint-projection");
let checks = 0;
...
process.stdout.write(`Mirror linked no-mint projection acceptance: ${checks}/${checks}\n`);
