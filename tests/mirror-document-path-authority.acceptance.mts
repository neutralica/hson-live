...
export const HSON_LIVE_TEST_METADATA = Object.freeze({
  id: "mirror.document-path-authority",
  title: "Document Mirror path authority",
  category: "Mirror",
  runtime: "node-synthetic-dom",
  tags: Object.freeze(["document", "binding", "path", "identity", "externally-discoverable"]),
});

const testEvents = create_test_event_emitter("mirror.document-path-authority");
let checks = 0;
