...
export const HSON_LIVE_TEST_METADATA = Object.freeze({
  ...
  title: "Strict Binary Hson rejection and resource safety",
  category: "Transform",
  runtime: "node",
  tags: Object.freeze(["binary", "rejection", "resource-limits", "worker", "public-api", "externally-discoverable"]),
});

const testEvents = create_test_event_emitter("transform.binary-hson-rejection");
let checks = 0;
