...
export const HSON_LIVE_TEST_METADATA = Object.freeze({
  ...
  title: "Hson single-quoted name acceptance and canonicalization",
  category: "Transform",
  runtime: "node",
  tags: Object.freeze(["hson", "quoted-name", "parsing", "serialization", "round-trip", "externally-discoverable"]),
});

const testEvents = create_test_event_emitter("transform.hson-quoted-name-acceptance");
let checks = 0;
