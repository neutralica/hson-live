...
export const HSON_LIVE_TEST_METADATA = Object.freeze({
  id: "mirror.supplied-identity-preservation",
  title: "Document Mirror supplied identity preservation",
  category: "Mirror",
  runtime: "node-synthetic-dom",
  tags: Object.freeze(["document", "binding", "quid", "runtime", "externally-discoverable"]),
});

const testEvents = create_test_event_emitter("mirror.supplied-identity-preservation");
let checks = 0;
...
process.stdout.write(`Mirror supplied identity preservation acceptance: ${checks}/${checks}\n`);
