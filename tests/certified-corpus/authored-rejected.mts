...
export const literalRejectedAuthoredHsonCases: readonly RejectedCorpusCase[] = [
  ...
  literal("hson.reject.literal.element.runtime-quid", "Portable Hson rejects runtime QUID metadata.", `<main @000000001/>`, { operation: "parse_hson", stage: "source-admission", code: "PORTABLE_RUNTIME_QUID_FORBIDDEN", source: { index: 6, line: 1, column: 7 } }, "element", "element-quid", "runtime-quid", ["element", "quid"]),
  ...
  literal("hson.reject.literal.object.quid", "Object-property QUIDs do not exist in authored Hson.", "<a @000000001 1>", tokenError("HSON_OBJECT_QUID_FORBIDDEN", 3), "object", "property-key", "object-quid", ["object", "quid"]),
  ...
  literal("hson.reject.literal.legacy-backtick-name", "Legacy backtick-delimited names are invalid.", "<`legacy name` 1>", tokenError("HSON_NAME_LEGACY_BACKTICK", 1), "object", "property-key", "legacy-backtick-name", ["object", "quoted-name", "legacy", "rejection"]),
  literal("hson.reject.literal.quoted-name.raw-apostrophe", "A literal apostrophe inside a quoted name must be escaped.", "<'don't' 1>", tokenError("HSON_NAME_UNTERMINATED", 7), "object", "property-key", "raw-apostrophe", ["object", "quoted-name", "apostrophe", "rejection"]),
  literal("hson.reject.literal.single-quoted-value", "Single quotes do not delimit object string values.", "<'name' 'value'>", tokenError("HSON_QUOTE_KIND_UNSUPPORTED", 8), "object", "property-value", "single-quoted-value", ["object", "string", "quote-kind", "rejection"]),
  ...
  literal("hson.reject.literal.element.duplicate-quid", "An element cannot declare two QUIDs.", "<e @000000001 @000000002/>", { operation: "tokenize-hson", stage: "tokenization", code: "HSON_ELEMENT_QUID_INVALID", source: { index: 14, line: 1, column: 15 }, related: [{ role: "first-declaration", source: { index: 3, line: 1, column: 4 } }] }, "element", "element-quid", "duplicate-quid", ["element", "quid"]),
  ...
  literal("hson.reject.literal.empty-element-name", "An empty decoded element name rejects.", "<''/>", tokenError("HSON_ELEMENT_NAME_REQUIRED", 1), "element", "element-name", "empty-decoded-name", ["element", "quoted-name", "empty-name"]),
  literal("hson.reject.literal.empty-attribute-name", "An empty decoded attribute name rejects.", "<e ''=\"x\"/>", tokenError("HSON_NAME_INVALID_START", 3), "element", "element-attribute", "empty-decoded-name", ["element", "attribute", "quoted-name", "empty-name"]),
  literal("hson.reject.literal.empty-flag-name", "An empty decoded flag name rejects.", "<e ''/>", tokenError("HSON_NAME_INVALID_START", 3), "element", "element-flag", "empty-decoded-name", ["element", "flag", "quoted-name", "empty-name"]),
