...
type WorkerResult = Readonly<{ certified: boolean; negativeZero: boolean; order: readonly string[]; exactOrder: readonly string[]; exactNegativeZero: boolean; safeProto: boolean; relationalAccepted: boolean; relationalRejected: boolean; emptyRev: number; emptyCount: number; primitiveMode: string; primitiveValue: number; broadDocument: boolean }>;
...
try {
  ...
  assert.deepEqual(result, { certified: true, negativeZero: true, order: ["second", "first"], exactOrder: ["10", "2"], exactNegativeZero: true, safeProto: true, relationalAccepted: true, relationalRejected: true, emptyRev: 0, emptyCount: 0, primitiveMode: "data-number", primitiveValue: 7, broadDocument: true });
