...
export const HSON_LIVE_TEST_METADATA = Object.freeze({
  ...
  title: "Linked identity authority registration",
  category: "LiveMap",
  runtime: "node-synthetic-dom",
  tags: Object.freeze(["document", "binding", "quid", "runtime", "authority", "externally-discoverable"]),
});

const testEvents = create_test_event_emitter("livemap.linked-identity-registration");
let checks = 0;
