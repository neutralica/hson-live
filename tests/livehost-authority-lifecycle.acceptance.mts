...
export const HSON_LIVE_TEST_METADATA = Object.freeze({
  ...
  title: "LiveHost Locus registry lifecycle",
  category: "LiveHost",
  runtime: "node",
  tags: Object.freeze(["locus-registry", "lifecycle", "eviction", "capacity", "restart", "externally-discoverable"]),
});

const testEvents = create_test_event_emitter("livehost.authority-lifecycle");
let checks = 0;
