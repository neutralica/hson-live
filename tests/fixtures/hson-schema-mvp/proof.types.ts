...
const fabricated: UserSchemaType = { name: "Ada", score: 37, flags: [true], pair: ["x", 2], account: { kind: "user", handle: "ada" } };
...
const reconstructed: UserSchemaType = { name: certified.name, score: certified.score, flags: certified.flags, pair: certified.pair, account: certified.account };
