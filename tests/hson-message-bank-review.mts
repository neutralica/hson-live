...
export const messageCases: readonly MessageCase[] = [
  ...
  { id: "schemaTypeMismatch", variant: "root", render: () => m.schemaTypeMismatch("this value", "fragment document root", "projected root"), expected: "Expected this value: fragment document root; received projected root." },
