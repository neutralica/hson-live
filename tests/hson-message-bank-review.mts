...
export const messageCases: readonly MessageCase[] = [
  ...
  { id: "schemaTypeMismatch", variant: "root", render: () => m.schemaTypeMismatch("this value", "document root", "data root"), expected: "Expected this value: document root; received data root." },
  ...
  { id: "schemaRequestRelated", variant: "certify", render: () => m.schemaRequestRelated("UserSchema"), expected: "Schema requested by this certify call (UserSchema)." },
