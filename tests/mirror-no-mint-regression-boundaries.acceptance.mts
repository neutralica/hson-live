...
export const HSON_LIVE_TEST_METADATA = Object.freeze({
  id: "mirror.no-mint-regression-boundaries",
  title: "Document Mirror no-mint regression boundaries",
  category: "Mirror",
  runtime: "node-synthetic-dom",
  tags: Object.freeze(["document", "binding", "quid", "runtime", "provenance", "externally-discoverable"]),
});

const testEvents = create_test_event_emitter("mirror.no-mint-regression-boundaries");
let checks = 0;
...
process.stdout.write(`Mirror no-mint regression boundaries acceptance: ${checks}/${checks}\n`);
