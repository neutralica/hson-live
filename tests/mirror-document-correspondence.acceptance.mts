...
import { DOCUMENT_MIRROR_STRUCTURAL_UPDATE_FAILED_ERROR_CODE } from "../src/api/mirror/mirror.document.error.ts";
import type {
  LiveMapAnyOp,
...
export const HSON_LIVE_TEST_METADATA = Object.freeze({
  id: "mirror.document-correspondence",
  title: "Document Mirror correspondence",
  category: "Mirror",
  runtime: "node-synthetic-dom",
  tags: Object.freeze(["document", "binding", "correspondence", "failure", "externally-discoverable"]),
});

const testEvents = create_test_event_emitter("mirror.document-correspondence");
let checks = 0;
