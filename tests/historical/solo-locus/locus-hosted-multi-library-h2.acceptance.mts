...
export const HSON_LIVE_TEST_METADATA = Object.freeze({
  id: "locus.hosted-multi-library-h2",
  title: "Hosted multi-library H2",
  category: "Locus",
  runtime: "node",
  tags: Object.freeze(["locus", "livemap", "libraries", "hosted", "h2"]),
});

const testEvents = create_test_event_emitter("locus.hosted-multi-library-h2");
let checks = 0;
...
await check("page Mirror receives structural work once while unrelated data only advances its global cursor", async () => {
