...
import type { HsonData } from "../../src/api/transform/transform.types.js";
import type { HsonSchema } from "../../src/api/transform/transform.types.js";
import type {
  LocusCanonicalCommit,
  LocusSnapshotCapabilities,
  LocusSnapshotEncodingSelection,
  LocusSnapshotEnvelope,
} from "./solo-locus-representation.types.js";
import type {
  LocusActionId,
  LocusActionName,
  ...
  LocusSeq,
  LocusValidator,
} from "../../src/types/locus.shared.types.js";
...
export type LocusClientSessionCreateMessage = Readonly<{
  ...
  projection?: import("../../src/types/locus.projection.types.js").LocusRequestedProjection;
}>;
...
export type LocusServerRecoveryCommitMessage = Readonly<{
  ...
  id: LocusRecoveryId;
  phase: "body" | "tail";
  commit: import("./solo-locus-representation.types.js").LocusClientCommit;
}>;
...
export type LocusServerRecoveryProgressMessage = Readonly<{
  ...
  id: LocusRecoveryId;
  phase: "body" | "tail";
  progress: import("./solo-locus-representation.types.js").LocusClientProgress;
}>;

export type LocusServerRecoverySnapshotMessage = Readonly<{
  type: "recovery-snapshot";
  id: LocusRecoveryId;
  snapshot: import("./solo-locus-representation.types.js").LocusClientSnapshotEnvelope;
}>;
